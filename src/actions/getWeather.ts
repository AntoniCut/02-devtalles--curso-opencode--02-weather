...
import type { WeatherInfo } from "../types/Weather.ts";
...
import type { DayForecast, WeeklyForecast } from "../types/Weather.ts";
...
export async function buildWeatherInfo(city: City, unit: AppData["unit"]): Promise<WeatherInfo | null> {
...
export async function getDefaultCityWeather(data: AppData): Promise<void> {
  console.log("");
...
export async function getAllCitiesWeather(data: AppData): Promise<void> {
  console.log("");
...
export async function buildWeeklyForecast(city: City, unit: AppData["unit"]): Promise<WeeklyForecast | null> {
